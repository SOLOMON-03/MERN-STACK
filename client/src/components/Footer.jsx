...
return (
    <footer className='bg-emerald-200 shadow-md'>
        <div className='flex flex-row justify-around items-start max-w-6xl mx-auto p-3 max-md:flex-col max-md:items-center'>
            <div>
                <form action="" className='rounded-lg flex flex-col gap-4'>
                    <h1 className='font-bold text-sm sm:text-2xl text-emerald-700'>Queries:</h1>
                    <input type="text" placeholder='Username' className='bg-emerald-100 rounded-lg focus:outline-none w-auto sm:w-64 p-2' id='username'/>
                    <input type="email" placeholder='Email' className='bg-emerald-100 rounded-lg focus:outline-none w-auto sm:w-64 p-2' id='email'/>
            ...
            <div>
                <h1 className='font-bold text-sm sm:text-2xl text-emerald-700 max-md:mt-5'>Quick Links:</h1>
